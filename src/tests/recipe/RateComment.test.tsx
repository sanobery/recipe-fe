...
describe('RateComment - Authorized User', () => {
    const renderWithStore = (type: 'rate' | 'comment' | 'delete') => {
        const store = mockStore({
            auth: {
                token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyaW5mbyI6eyJ1c2VySWQiOiI2OGQyNzU4NzU5NmI0MTc5ODg4MzhiZWYifSwiaWF0IjoxNzU4NzA3MDM2LCJleHAiOjE3NTg3MDcwNDJ9.7XzMAPtI4BfnprUHZDqQ_RoAQvzj8YF41XqG11lGjE0',
    ...
    it('submits a valid comment payload', async () => {
        ...
        fireEvent.change(commentInput, {
            target: { value: 'This recipe is awesome!' },
        })
